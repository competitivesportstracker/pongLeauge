...
class BeerPongLeague {
    ...
    startNewGame() {
        ...
        this.currentGame = {
            ...
            playersShot: [false, false], // Track which players have shot this turn [player0, player1]
            playersMade: [false, false], // Track which players made their shot this turn
            actions: [],
            stats: {
                team1: {
                    shots: 0,
    ...
    recordMake(targetTeam, cupId) {
        ...
        const action = {
            ...
            cupId: cupId,
            isIsland: isIsland,
            playersShotBeforeAction: [...this.currentGame.playersShot],
            playersMadeBeforeAction: [...this.currentGame.playersMade],
            timestamp: Date.now()
        };
        ...
        // Mark this player as having shot and made
        this.currentGame.playersShot[this.currentGame.currentPlayer] = true;
        this.currentGame.playersMade[this.currentGame.currentPlayer] = true;

        // Check if both players have shot
        if (this.currentGame.playersShot[0] && this.currentGame.playersShot[1]) {
            // Both players shot - check for balls back
            if (this.currentGame.playersMade[0] && this.currentGame.playersMade[1]) {
                ...
                this.currentGame.playersShot = [false, false];
                this.currentGame.playersMade = [false, false];
                this.currentGame.currentPlayer = 0;
            } else {
                // Not balls back, switch to other team
            ...
            // Other player still needs to shoot - find who hasn't shot yet
            this.currentGame.currentPlayer = this.currentGame.playersShot[0] ? 1 : 0;
        }
    ...
    recordMiss() {
        ...
        // Mark this player as having shot (but not made)
        this.currentGame.playersShot[this.currentGame.currentPlayer] = true;
        // playersMade stays false for this player

        // Check if both players have shot
        if (this.currentGame.playersShot[0] && this.currentGame.playersShot[1]) {
            // Both players shot, switch to other team
            this.currentGame.currentTeam = this.currentGame.currentTeam === 1 ? 2 : 1;
            this.currentGame.currentPlayer = 0;
            this.currentGame.playersShot = [false, false];
            this.currentGame.playersMade = [false, false];
    ...
    undoLastAction() {
        ...
        this.currentGame.playersShot = lastAction.playersShotBeforeAction || [false, false];
        this.currentGame.playersMade = lastAction.playersMadeBeforeAction || [false, false];
